...
namespace App.WindowsApp.Forms
{
    ...
    {
        private ReservationFormModeEnum _mode;
            ...
            IMemberService memberService)
        {
            ...
            if (mode == ReservationFormModeEnum.Edit)
            {
                buttonSave.Text = "Update";
                this.Text = "Edit Reservation";
                labelReservationDetails.Text = "Edit Reservation";
            }
            else if (mode == ReservationFormModeEnum.View)
            {
                buttonSave.Visible = false;
                this.Text = "View Reservation";
                labelReservationDetails.Text = "View Reservation";
            }
            else
            {
                this.Text = "Add Reservation";
                labelReservationDetails.Text = "Add Reservation";
                labelId.Visible = false;
                textBoxReservationId.Visible = false;
            ...
            if (mode == ReservationFormModeEnum.Edit || mode == ReservationFormModeEnum.View)
            {
        ...
        private bool ValidateData()
        {
            ...
            if (comboBoxStatus.SelectedItem is not ReservationStatus)
            {
            ...
            if (checkBoxHasExpiry.Checked &&
                dateTimePickerExpiryDate.Value.Date < dateTimePickerReservationDate.Value.Date)
            {
                MessageBox.Show("Expiry date cannot be before reservation date.", "Validation",
                    MessageBoxButtons.OK, MessageBoxIcon.Warning);
                dateTimePickerExpiryDate.Focus();
                return false;
            }
            return true;
        }
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ReservationStatus selectedStatus = (ReservationStatus)comboBoxStatus.SelectedItem;
                ...
                if (_mode == ReservationFormModeEnum.Add)
                {
                    ...
                    textBoxReservationId.Text = newReservation.Id;
